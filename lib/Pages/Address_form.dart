...
class _AddressState extends State<Address> {
  ...
  _getAddress() async {
    ...
    List<DocumentSnapshot> data = await addressService.getUserAddress()
        .catchError((e) {
      print(e);
    });
    setState(() {
  ...
  Widget build(BuildContext context) {
    return isLoading?Loading():address.length != 0 ? Scaffold(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Padding(
                      ...
                      child: Text('${address[0]['name']}', style: TextStyle(
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: <Widget>[
                          Text('Mobile:'),
                          SizedBox(width: 10,),
                          Text('${address[0]['mobileNo']}', style: TextStyle(
                              color: Colors.black, fontWeight: FontWeight.bold))
                        ],
                      ),
                    ),
      ...
      bottomNavigationBar: Container(
        ...
        child: Padding(
          padding:
          const EdgeInsets.only(bottom: 7, left: 15, right: 15, top: 10),
          child: FlatButton(
            onPressed: () {
    Navigator.push(
    context, MaterialPageRoute(builder: (context) => PaymentCheckout()));
            },
            color: Colors.black,
            child: Padding(
              padding: const EdgeInsets.all(16.0),
            ...
            onPressed: () {
              if (_formKey.currentState.validate()) {
                if (city != null && state != null) {
                  ...
                  Fluttertoast.showToast(msg: "Please enter a valid pin-code",
                    backgroundColor: Colors.black,
